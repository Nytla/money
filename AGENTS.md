...
Требования: `docs/PROJECT.md` (решения, модель, объём), `docs/TZ.txt` (исходник),
...
сумм и дат. Полный регламент и его текущий статус — в разделе 6 `docs/PROJECT.md`.
Карта проектных документов и цепочка скиллов фазы A — там же, в начале файла.
